...
%%  xlabel('time (s)');
%%  ylabel('error');
%%  saveas(gcf, 'Example54_error.fig');
%%  saveas(gcf, 'Example54_error', 'png');
...
%saveas(gcf, 'Example54_RT_recon', 'png');
%saveas(gcf, 'Example54_RT_recon.fig');
...
%%  saveas(gcf, 'Example54_error_recon', 'png');
%%  saveas(gcf, 'Example54_error_recon.fig');
...
%%  end
%%  normRT = max(energy_RT{2});
%%  normKW = max(energy_KW{2});
%%  for i = 1:nSensors
