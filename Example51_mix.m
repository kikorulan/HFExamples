...
saveas(gcf, 'Example51_mix_RT-kWave_recon', 'png');
saveas(gcf, 'Example51_mix_RT-kWave_recon.fig');
...
saveas(gcf, 'Example51_mix_kWave-RT_recon', 'png');
saveas(gcf, 'Example51_mix_kWave-RT_recon.fig');
...
saveas(gcf, 'Example51_mix_error','png');
saveas(gcf, 'Example51_mix_error.fig');
