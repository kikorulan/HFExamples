...
% Save to disk
filename = 'input_data/Example53_forward_input.h5';
...
system('../kspaceFirstOrder3D-OMP -i input_data/Example53_forward_input.h5 -o output_data/Example53_forward_output.h5');
...
ylabel('x (m)');
title('Sound Speed');
saveas(gcf, 'Example53_C', 'png');
saveas(gcf, 'Example53_C.fig');
...
saveas(gcf, 'Example53_U', 'png');
saveas(gcf, 'Example53_U.fig');
