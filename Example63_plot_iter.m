...
% Initial Pressure
%==============================
initial_pressure_matrix = importdata('input_data/initial_pressure_veins.dat', ' ', 0);
initial_pressure = matrix2cube(initial_pressure_matrix, Nz);
plot_pixel(initial_pressure, 8, dx);
...
ax.GridAlpha = 0.5;
grid on;
saveas(gcf, 'Example63_RT_recon_FISTA_50iter.fig');
saveas(gcf, 'Example63_RT_recon_FISTA_50iter', 'png');


recon_matrix = importdata('output_data/y_k.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
plot_pixel(reconRT, 5, dx);
...
recon_matrix = importdata('output_data/11.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
plot_pixel(reconRT, 5, dx);

recon_matrix = importdata('output_data/pixelPressure_0.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_1.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_2.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_3.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_11.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 2, dx);
...
ax.GridAlpha = 0.5;
grid on;
saveas(gcf, 'Example63_RT_recon_SPDHG_10epochs.fig');
saveas(gcf, 'Example63_RT_recon_SPDHG_10epochs', 'png');


recon_matrix = importdata('output_data/PixelPressure.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_u.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_x_k.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
plot_pixel(reconRT, 8, dx);
...
recon_matrix = importdata('output_data/pixelPressure_PDHG_0.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_PDHG_1.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_PDHG_4.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_PDHG_6.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);

recon_matrix = importdata('output_data/pixelPressure_PDHG_aux.dat', ' ', 0);
reconRT = matrix2cube(recon_matrix, Nz);
reconRT = max(reconRT, 0);
plot_pixel(reconRT, 8, dx);
...
%==================================================
for i = 0:20
    recon_matrix = importdata(['output_data/pixelAttenuation_', int2str(i), '.dat'], ' ', 0);
    reconRT = matrix2cube(recon_matrix, Nz);
    reconRT = max(reconRT, 0);
    plot_pixel(reconRT, 8, dx);
end
...
saveas(gcf, 'output_data/Example63_RTrecon_3D', 'png');
saveas(gcf, 'output_data/Example63_RTrecon_3D.fig');
