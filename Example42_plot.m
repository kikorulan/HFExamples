...
%clear all;
close all;
load input_data/sensor_data.mat
...
%==================================================
load output_data/kgrid_data.mat;
% Normalisation - RT
...
saveas(gcf, 'Example42_RT.fig');
saveas(gcf, 'Example42_RT', 'png');
...
xlabel('time (s)');
ylabel('error');
saveas(gcf, 'Example42_error.fig');
saveas(gcf, 'Example42_error', 'png');
...
saveas(gcf, 'Example42_RT_recon', 'png');
saveas(gcf, 'Example42_RT_recon.fig');

%==================================================
% RECONSTRUCTION - kWave
%==================================================
p0_recon_PML = h5read('output_data/Example42_adjoint_output.h5', '/p_final');
PML_size = 10;
...
saveas(gcf, 'Example42_kWave_recon', 'png');
saveas(gcf, 'Example42_kWave_recon.fig');
...
%%  saveas(gcf, 'Example42_error_recon', 'png');
%%  saveas(gcf, 'Example42_error_recon.fig');
