...
dlmwrite('input_data/soundSpeed_homogeneous.dat',  c_matrix, 'delimiter', ' ');
...
% Save to disk
filename = 'input_data/Example54_forward_input.h5';
...
system('../kspaceFirstOrder3D-OMP -i input_data/Example54_forward_input.h5 -o output_data/Example54_forward_output.h5');
save input_data/sensor_data_3balls.mat kgrid medium source sensor input_args;
...
ylabel('x (m)');
title('Sound Speed');
saveas(gcf, 'Example54_C', 'png');
saveas(gcf, 'Example54_C.fig');
...
saveas(gcf, 'Example54_U', 'png');
saveas(gcf, 'Example54_U.fig');

%==================================================
% TIME SIGNAL - kWave
%==================================================
sensor_data = h5read('output_data/Example54_forward_output.h5', '/p');
figure;
imagesc(sensor_data);
box on;
