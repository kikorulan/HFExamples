...
% Save to disk
filename = 'input_data/Example56_forward_input.h5';
...
system('../kspaceFirstOrder3D-OMP -i input_data/Example56_forward_input.h5 -o output_data/Example56_forward_output.h5');
...
ylabel('x (m)');
title('Sound Speed');
saveas(gcf, 'Example56_C', 'png');
saveas(gcf, 'Example56_C.fig');
...
saveas(gcf, 'Example56_U', 'png');
saveas(gcf, 'Example56_U.fig');
