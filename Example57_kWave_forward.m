...
% Save to disk
filename = 'input_data/Example57_forward_input.h5';
...
system('../kspaceFirstOrder3D-OMP -i input_data/Example57_forward_input.h5 -o output_data/Example57_forward_output.h5');
...
ylabel('x (m)');
title('Sound Speed');
saveas(gcf, 'Example57_C', 'png');
saveas(gcf, 'Example57_C.fig');
...
saveas(gcf, 'Example57_U', 'png');
saveas(gcf, 'Example57_U.fig');
