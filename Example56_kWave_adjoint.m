...
% Save and run
%kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example56_adjoint_input.h5');
%system('../kspaceFirstOrder3D-OMP -i input_data/Example56_adjoint_input.h5 -o output_data/Example56_adjoint_output.h5 --p_final');
...
for i = 44:nSensors
    ...
    % Sensor
    kspaceFirstOrder3D(kgrid, medium, source_adjoint{i}, sensor_adjoint, input_args{:}, 'SaveToDisk', ['input_data/Example56_adjoint_input_' int2str(i) '.h5']);
    system(['../kspaceFirstOrder3D-OMP -i input_data/Example56_adjoint_input_' int2str(i) '.h5 -o output_data/Example56_adjoint_output_' int2str(i) '.h5 --p_final']);
    %pause
end
