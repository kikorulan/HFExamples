...
run colourMap;
load input_data/sensor_data_mask.mat;
...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example66_adjoint_input.h5');
system('../kspaceFirstOrder3D-OMP -i input_data/Example66_adjoint_input.h5 -o output_data/Example66_adjoint_output.h5 --p_final');
...
% Reconstruction
%==============================
p0_recon_PML = h5read('output_data/Example66_adjoint_output.h5', '/p_final');
PML_size = 10;
...
% Plot figure
plot_pixel(inputKWave_norm, 2, kgrid.dx);
saveas(gcf, 'output_data/Example66_kWave_recon.fig');
