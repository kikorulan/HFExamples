...
%==============================
% Read results
sensor_data = h5read('output_data/Example74_forward_output_14400sensors.h5', '/p');
...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example74_adjoint_input_14400sensors.h5');
system('../kspaceFirstOrder3D-OMP -i input_data/Example74_adjoint_input_14400sensors.h5 -o output_data/Example74_adjoint_output_14400sensors.h5 --p_final');
