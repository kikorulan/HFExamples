...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example74_adjoint_input_1600sensors.h5');
system('../kspaceFirstOrder3D-OMP -i input_data/Example74_adjoint_input_1600sensors.h5 -o output_data/Example74_adjoint_output_1600sensors.h5 --p_final');
