...
system('../kspaceFirstOrder3D-OMP -i input_data/Example59_adjoint_input.h5 -o output_data/Example59_adjoint_output.h5 --p_final');
...
% Plot figure
plot_pixel(inputKWave_norm, 10, kgrid.dx, false);
