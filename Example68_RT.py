...
# Sensors
file_sensors = input_folder + "sensors_subsampled.dat"
...
#==============================
# Comparison 
file_forward_signal = input_folder + "forwardSignal_reference.dat"
...
# Error
errorImage = forward_signal - forward_signal[1:, :]
plt.figure()
