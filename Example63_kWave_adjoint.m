...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example63_adjoint_input.h5');
system('../kspaceFirstOrder3D-OMP -i input_data/Example63_adjoint_input.h5 -o output_data/Example63_adjoint_output.h5 --p_final');
