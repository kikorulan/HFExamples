...
%==================================================
% Import data
load input_data/sensor_data_2balls;
sensor_data = h5read('output_data/Example55_forward_output.h5', '/p');
filenameData = 'output_data/ForwardSignal.dat';
timeSignal = importdata(filenameData, delimiterIn, headerlinesIn);
% Input
...
%%  xlabel('time (s)');
%%  ylabel('error');
%%  saveas(gcf, 'Example55_error.fig');
%%  saveas(gcf, 'Example55_error', 'png');
...
%%  %saveas(gcf, 'Example55_RT_recon', 'png');
%%  %saveas(gcf, 'Example55_RT_recon.fig');
...
%%  saveas(gcf, 'Example55_error_recon', 'png');
%%  saveas(gcf, 'Example55_error_recon.fig');
