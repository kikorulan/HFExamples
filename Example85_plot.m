...
saveas(gcf, './figures_paper/Example80_initial_pressure', 'epsc');
...
imagesc(y0(1:60, :));
colorbar()
saveas(gcf, './figures_paper/Example80_forwardSignal_noisy5', 'epsc');
...
saveas(gcf, './figures_paper/Example80_pixelPressure_adjoint', 'epsc');
...
saveas(gcf, ['./figures_paper/Example80_GD'], 'epsc');
