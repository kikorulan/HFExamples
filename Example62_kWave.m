...
%sensor.mask(1, :) = 1;
sensor.mask(1, 1:subsample_factor:end)    = 1;
sensor.mask(end, end:-subsample_factor:1) = 1;
sensor.mask(1:subsample_factor:end, 1)    = 1;
sensor.mask(end:-subsample_factor:1, end) = 1;
...
source_adjoint.p_mask(1, 1:subsample_factor:end)    = 1;
source_adjoint.p_mask(end, end:-subsample_factor:1) = 1;
source_adjoint.p_mask(1:subsample_factor:end, 1)    = 1;
source_adjoint.p_mask(end:-subsample_factor:1, end) = 1;
...
axis image;
saveas(gcf, 'Example62_U_kWave.fig');
...
saveas(gcf, 'Example62_kWave_recon_timeReversal.fig'); 
...
saveas(gcf, 'Example62_kWave_recon_adjoint.fig'); 
