...
adjointRT_smooth = Rgrid.pixelAReverse;
save adjointRT_smooth adjointRT_smooth;
...
%%  %title('Initial Pressure');
%%  saveas(gcf, 'Example51_U_nonsmooth', 'png'); 
%%  saveas(gcf, 'Example51_U_nonsmooth.fig'); 
...
%%  saveas(gcf, 'Example51_RT_errorKW_nonsmooth', 'png');
%%  saveas(gcf, 'Example51_RT_errorKW_nonsmooth.fig');
...
%%  set(gcf, 'pos', positionYBar);
%%  %title('Error RT - kWave (ADJ)');
%%  saveas(gcf, 'Example51_RT_error_nonsmooth', 'png');
%%  saveas(gcf, 'Example51_RT_error_nonsmooth.fig');
