...
xlabel('t [\mus]');
ylabel('Amplitude');
%%  saveas(gcf, 'Example51_Sensor1_signal_GB', 'png');
%%  saveas(gcf, 'Example51_Sensor1_signal_GB.fig'); 
% Sensor 2;
figure; hold on;
axis([0 40 -.6 1.2]);
...
xlabel('t [\mus]');
ylabel('Amplitude');
%%  saveas(gcf, 'Example51_Sensor2_signal_GB', 'png');
%%  saveas(gcf, 'Example51_Sensor2_signal_GB.fig'); 
% Sensor 3
figure; hold on;
axis([0 40 -.6 1.2]);
...
xlabel('t [\mus]');
ylabel('Amplitude');
%%  saveas(gcf, 'Example51_Sensor3_signal_GB', 'png');
%%  saveas(gcf, 'Example51_Sensor3_signal_GB.fig'); 
% Errors
...
xlabel('t [\mus]');
ylabel('Amplitude');
%%  saveas(gcf, 'Example51_error_signal_GB', 'png');
%%  saveas(gcf, 'Example51_error_signal_GB.fig'); 
