...
cd /cs/research/medim/projects2/projects/frullan/Documents/HighFreqCode/Examples/Ex42_RT_3D;
...
% Save to disk
filename = 'input_data/Example42_forward_input.h5';
...
system('../kspaceFirstOrder3D-OMP -i input_data/Example42_forward_input.h5 -o output_data/Example42_forward_output.h5');

%==============================
% Adjoint
%==============================
%% Read results
sensor_data_3balls = h5read('output_data/Example42_forward_output.h5', '/p');
...
kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example42_adjoint_input.h5');
system('../kspaceFirstOrder3D-OMP -i input_data/Example42_adjoint_input.h5 -o output_data/Example42_adjoint_output.h5 --p_final');

save output_data/kgrid_data.mat kgrid medium source sensor source_adjoint sensor_adjoint input_args;
%=========================================================================
% VISUALISATION
%=========================================================================
cd /cs/research/medim/projects2/projects/frullan/Documents/HighFreqCode/Examples/Ex42_RT_3D;
...
ylabel('x (m)');
title('Sound Speed');
saveas(gcf, 'Example42_C', 'png');
saveas(gcf, 'Example42_C.fig');
...
saveas(gcf, 'Example42_U', 'png');
saveas(gcf, 'Example42_U.fig');
