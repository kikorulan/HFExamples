...
%==============================
disp('GD');
GD.tau = {'5e17', '1e18', '2e18', '4e18'};
GD.nIter = {10, 10, 18, 10};
GD.lambda = '1e-3';
L = length(GD.tau);
clear GD_error_pd;
for ii = 1:L
...
ax = gca;
ax.GridAlpha = 0.2;
legend('GD 5e17', 'GD 1e18', 'GD 2e18', 'GD 4e18');
...
ax = gca;
ax.GridAlpha = 0.2;
legend('SGD 8e18', 'SGD 1.6e19', 'SGD 3.2e19');
...
%==============================
disp('FISTA');
FISTA.tau = {'5e17', '1e18', '2e18', '4e18'};
FISTA.nIter = {10, 10, 10, 10};
FISTA.lambda = '1e-3';
L = length(FISTA.tau);
...
ax = gca;
ax.GridAlpha = 0.2;
legend('FISTA 5e17', 'FISTA 1e18', 'FISTA 2e18', 'FISTA 4e18');
...
%==============================
disp('PDHG');
PDHG.tau = {'5e17', '1e18', '2e18', '4e18'};
PDHG.nIter = {10, 10, 18, 10};
PDHG.sigma = '1';
PDHG.theta = '1';
PDHG.lambda = '1e-3';
L = length(PDHG.tau);
...
ax = gca;
ax.GridAlpha = 0.2;
legend('PDHG 5e17', 'PDHG 1e18', 'PDHG 2e18', 'PDHG 4e18');
...
%==============================
disp('S-PDHG');
SPDHG.tau = {'5e16', '1e17', '2e17', '5e17', '1e18', '2e18'};
SPDHG.sigma = '1';
SPDHG.theta = '1';
SPDHG.batch = '100';
SPDHG.nIter = {8, 8, 17, 8, 8, 8};
SPDHG.lambda = '1e-3';
L = length(SPDHG.tau);
...
ax.GridAlpha = 0.2;
axis([0 17 1 100]);
legend('SPDHG 5e16', 'SPDHG 1e17', 'SPDHG 2e17', 'SPDHG 5e17', 'SPDHG 1e18', 'SPDHG 2e18');
...
semilogy(0:FISTA.nIter{3}, FISTA_error_pd{3}, 'Color', 'b', 'Linewidth', 1.5);
semilogy(0:PDHG.nIter{3}, PDHG_error_pd{3}, 'Color', 'm', 'Linewidth', 1.5);
semilogy(0:SPDHG.nIter{3}, SPDHG_error_pd{3}, 'Color', 'c', 'Linewidth', 1.5);
...
hold on;       
semilogy(0:SGD.nIter{1}, SGD_error_dd{1}, 'Color', 'g', 'Linewidth', 1.5);
...
semilogy(0:SPDHG.nIter{3}, SPDHG_error_dd{3}, 'Color', 'c', 'Linewidth', 1.5);
legend('GD', 'S-GD', 'FISTA', 'PDHG', 'S-PDHG');
