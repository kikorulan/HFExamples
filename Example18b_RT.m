...
title('Trajectories');
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex18_RT_interf_Q/Example18b_Ray_rev.fig');
...
xlabel('tau (m*m/s)');
ylabel('time (s)');
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex18_RT_interf_Q/Example18b_TimeVsTau_rev.fig');
...
legend('Ray 1 - ODE', 'Ray 2 - ODE');
grid on;
xlabel('time (s)');
ylabel('Amplitude');
title('Amplitude (Reversal)');
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex18_RT_interf_Q/Example18b_A.fig');
...
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex18_RT_interf_Q/Example18_Q_ODE.fig');
