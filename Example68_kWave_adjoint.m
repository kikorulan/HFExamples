...
run colourMap;
load ./input_data/sensor_data_veins.mat;
...
%==============================
% Read results
sensor_data = h5read('output_data/Example68_forward_output_36sensors.h5', '/p');
...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example68_adjoint_input_36sensors.h5');
system('../kspaceFirstOrder3D-OMP -i input_data/Example68_adjoint_input_1600sensors.h5 -o output_data/Example68_adjoint_output_36sensors.h5 --p_final');
