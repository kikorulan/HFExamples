...
run colourMap;
load input_data/sensor_data_2balls.mat;
...
% Save and run
%kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example55_adjoint_input.h5');
%system('../kspaceFirstOrder3D-OMP -i input_data/Example55_adjoint_input.h5 -o output_data/Example55_adjoint_output.h5 --p_final');
...
for i = 11:nSensors
    ...
    source_adjoint{i}.p = fliplr(sensor_data(i, :));
    % Sensor
    kspaceFirstOrder3D(kgrid, medium, source_adjoint{i}, sensor_adjoint, input_args{:}, 'SaveToDisk', ['input_data/Example55_adjoint_input_' int2str(i) '.h5']);
    system(['../kspaceFirstOrder3D-OMP -i input_data/Example55_adjoint_input_' int2str(i) '.h5 -o output_data/Example55_adjoint_output_' int2str(i) '.h5 --p_final']);
    %pause
end
...
% Reconstruction
%==============================
p0_recon_PML = h5read('output_data/Example55_adjoint_output.h5', '/p_final');
PML_size = 10;
...
saveas(gcf, 'Example55_kWave_recon', 'png');
saveas(gcf, 'Example55_kWave_recon.fig');

%==============================
% Reconstruction
%==============================
%%  for i = 1:3
%%      p0_recon_PML = h5read(['output_data/Example55_adjoint_output_' int2str(i) '.h5'], '/p_final');
%%      PML_size = 10;
