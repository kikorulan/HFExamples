...
imagesc(y0(1:60, :));
colorbar()
saveas(gcf, './figures_paper/Example81_forwardSignal_noisy5', 'epsc');
...
saveas(gcf, './figures_paper/Example81_sound_speed', 'epsc');
...
saveas(gcf, './figures_paper/Example81_pixelPressure_adjoint', 'epsc');
...
saveas(gcf, './figures_paper/Example81_GD', 'epsc');
...
pixelPressure = max(0, matrix2cube(pixelPressureMatrix, Nz));
plot_projection_compact(pixelPressure, dx);
saveas(gcf, './figures_paper/Example81_S-GD', 'epsc');
...
pixelPressure = max(0, matrix2cube(pixelPressureMatrix, Nz));
plot_projection_compact(pixelPressure, dx);
saveas(gcf, './figures_paper/Example81_FISTA', 'epsc');
...
pixelPressure = max(0, matrix2cube(pixelPressureMatrix, Nz));
plot_projection_compact(pixelPressure, dx);
saveas(gcf, './figures_paper/Example81_PDHG', 'epsc');
...
pixelPressure = max(0, matrix2cube(pixelPressureMatrix, Nz));
plot_projection_compact(pixelPressure, dx);
saveas(gcf, './figures_paper/Example81_S-PDHG', 'epsc');
...
ylabel('primal error');
set(gca,'FontSize',15);
saveas(gcf, './figures_paper/Example81_pd_error', 'epsc');
...
set(gca,'FontSize',15);
saveas(gcf, './figures_paper/Example81_relativeDualError', 'epsc');
