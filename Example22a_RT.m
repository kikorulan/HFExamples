...
view(2);
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex22_RT_kWave_interf/Example22_C.fig'); 
...
surf(x, y, flipGrid, 'EdgeColor', 'none');
view(2);
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex22_RT_kWave_interf/Example22_U.fig'); 
...
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex22_RT_kWave_interf/Example22_RevAmplitude.fig');
...
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex22_RT_kWave_interf/Example22_Ray.fig');
...
legend('Sensor 1', 'Sensor 2', 'Sensor 3');
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex22_RT_kWave_interf/Example22_aSignal.fig');
...
for n = 1:nSources
    ...
    plot(tSpline, sConv(1+maxFilter:lSpline+maxFilter)/max(Filter)*2.5, 'Color', colourMapV(n));
...
saveas(gcf, '~/Documents/MATLAB/HighFreq/Examples/Ex22_RT_kWave_interf/Example22_aSignalConv.fig');
