...
%==============================
% Read results
sensor_data_3balls = h5read('output_data/Example53_forward_output.h5', '/p');
...
for i = 1:nSensors
    ...
    kspaceFirstOrder3D(kgrid, medium, source_adjoint{i}, sensor_adjoint, input_args{:}, 'SaveToDisk', ['input_data/Example53_adjoint_input_' int2str(i) '.h5']);
    system(['../kspaceFirstOrder3D-OMP -i input_data/Example53_adjoint_input_' int2str(i) '.h5 -o output_data/Example53_adjoint_output_' int2str(i) '.h5 --p_final']);
    %pause
end
