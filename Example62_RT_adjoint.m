...
%save recon_data_RT.mat Rgrid source -v7.3;
%================================================================================
% VISUALISATION
%===============================================================================
cd /cs/research/medim/projects2/projects/frullan/Documents/HighFreqCode/Examples/Ex62_recon2D_subsample;
...
saveas(gcf, 'Example62_RT_recon', 'png');
saveas(gcf, 'Example62_RT_recon.fig');
...
saveas(gcf, 'Example62_kWave_recon', 'png');
saveas(gcf, 'Example62_kWave_recon.fig');
...
saveas(gcf, 'Example62_RT_errorKW', 'png');
saveas(gcf, 'Example62_RT_errorKW.fig');
...
set(gcf, 'pos', positionYBar);
%title('Error RT - kWave (ADJ)');
saveas(gcf, 'Example62_RT_error', 'png');
saveas(gcf, 'Example62_RT_error.fig');
...
%%  colorbar();
%%  title('Error: kWave');
%%  saveas(gcf, 'Example62_kWave_error.fig');
...
%%  saveas(gcf, 'Example62_RT_sensor128', 'png'); 
%%  saveas(gcf, 'Example62_RT_sensor128.fig');
