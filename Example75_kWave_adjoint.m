...
%==============================
% Read results
sensor_data = h5read('output_data/Example75_forward_output_1600sensors.h5', '/p');
...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adjoint, sensor_adjoint, input_args{:}, 'SaveToDisk', 'input_data/Example75_adjoint_input_1600sensors.h5');
system('../kspaceFirstOrder3D-OMP -i input_data/Example75_adjoint_input_1600sensors.h5 -o output_data/Example75_adjoint_output_1600sensors.h5 --p_final');
...
%=========================================================================
PML_size = 10;
u_PML = h5read('output_data/Example75_adjoint_output_1600sensors.h5', '/p_final');
