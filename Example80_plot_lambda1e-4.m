...
ax.GridAlpha = 0.2;
axis([0 30 1 100]);
saveas(gcf, ['./figures/Example80_pd_lambda1em4_error.fig']);
...
% Plot
figure();
semilogy(0:GD.nIter{1}, GD_error_dd{1}, 'Color', 'r', 'Linewidth', 1.5);
hold on;       
...
semilogy(0:PDHG.nIter{1}, PDHG_error_dd{1}, 'Color', 'm', 'Linewidth', 1.5);
...
ax.GridAlpha = 0.2;
axis([0 30 1e-19 1e-17]);
saveas(gcf, ['./figures/Example80_dd_lambda1e-4_error.fig']);
